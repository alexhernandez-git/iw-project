    ...
    <div className="col-span-6 sm:col-span-3">
      <Combobox as="div" value={optionsValues} onChange={onChange}>
        ...
        <div className="relative mt-1">
          <Combobox.Input
            className="w-full rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 shadow-sm focus:border-esan-color focus:outline-none focus:ring-1 focus:ring-esan-color sm:text-sm"
                ...
                <Combobox.Option
                  ...
                  className={({ active }) =>
                    classNames(
                      ...
                      active ? "bg-esan-color text-white" : "text-gray-900"
                    )
                  }
                >
                  {({ active, selected }) => (
                      ...
                      {selected && (
                        <span
                          className={classNames(
                            ...
                            active ? "text-white" : "text-esan-color"
                          )}
                        >
